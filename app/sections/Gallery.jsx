...
const Gallery = () => {
  return (
    <section className="w-full bg-black-background h-fit max-container flex justify-center items-center px-20">
        <div className="flex flex-col justify-center items-center gap-9 py-20">
            <h2 className="text-5xl text-white text-center font-montserrat">Scenic Routes Captured</h2>
